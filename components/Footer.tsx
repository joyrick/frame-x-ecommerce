    ...
    <footer className="bg-black/50 border-t border-gray-900">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
          {/* Informácie */}
          <div>
            <h3 className="text-lg font-bold text-white uppercase tracking-wider mb-4">{t('footer.information')}</h3>
            <ul className="space-y-3">
              ...
              <FooterLink href="#" className="text-ferrari-red hover:text-red-400 font-semibold">{t('footer.wholesale')}</FooterLink>
            </ul>
          </div>

          {/* Produkty */}
          <div>
            <h3 className="text-lg font-bold text-white uppercase tracking-wider mb-4">{t('footer.products')}</h3>
            <ul className="space-y-3">
              <FooterLink href="#">{t('footer.moneyEnvelopes')}</FooterLink>
              <FooterLink href="#">{t('footer.drinkingSets')}</FooterLink>
              <FooterLink href="#">{t('footer.honeyBottles')}</FooterLink>
              <FooterLink href="#">{t('footer.emergencyGlass')}</FooterLink>
              <FooterLink href="#">{t('footer.cuttingBoards')}</FooterLink>
              <FooterLink href="#">{t('footer.bottleBoxes')}</FooterLink>
            </ul>
          </div>

          {/* Adresa */}
          <div>
            <h3 className="text-lg font-bold text-white uppercase tracking-wider mb-4">{t('footer.address')}</h3>
            <div className="text-gray-400 space-y-1">
              <p>IČO: 34689427</p>
              <p>DIČ: 1026215124</p>
              <p className="font-semibold text-gray-300 mt-3">{t('footer.pickupLocation')}</p>
          ...
          {/* Kontakt */}
          <div>
            <h3 className="text-lg font-bold text-white uppercase tracking-wider mb-4">{t('footer.contact')}</h3>
            <div className="text-gray-400 space-y-3">
              ...
              <div className="flex space-x-4 pt-2">
                <a href="https://www.facebook.com/humornedarceky" className="text-gray-500 hover:text-white transition-colors" aria-label="Facebook">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v2.385z" />
                  </svg>
                </a>
                <a href="https://www.instagram.com/humornedarceky.sk/" className="text-gray-500 hover:text-white transition-colors" aria-label="Instagram">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-12 border-t border-gray-800 pt-6 text-center text-gray-500 text-sm">
          &copy; {new Date().getFullYear()} Frame X. {t('footer.rights')}
        </div>
      </div>
    </footer>
  );
